...
- Acid deposition occurs when acidic pollutants such as sulfur dioxide and nitrogen oxides react with water vapor and other chemicals in the atmosphere, forming acid rain or snow. Acid deposition can have direct effects on bird vocalizations by damaging the respiratory system and vocal organs of birds, leading to changes in song quality and quantity. A study by Powell et al. (2005) found that acid deposition caused a decline in bird species richness and led to changes in the vocalizations of forest birds in the eastern United States.
