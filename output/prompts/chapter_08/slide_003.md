...
- Title: "The Impact of Air Quality on Birds"
...
- } Poor air quality can have significant impacts on bird populations, including respiratory problems, reduced fitness, habitat loss, changes in behavior, and mortality. Birds can be particularly sensitive to pollutants such as ozone, sulfur dioxide, nitrogen dioxide, and particulate matter, which can cause respiratory distress and other health problems. By improving air quality and protecting bird habitats, we can help to ensure the health and diversity of bird populations around the world.
- Figure: Schematic of a bird highlighting key components of the hypothalamic–pituitary–gonadal axis (HPG axis) and hypothalamic–pituitary–adrenal axis (HPA axis) taken from:2020
- Bird song is an essential aspect of avian behavior that is influenced by various environmental factors. The environmental impacts on bird song include habitat loss, noise pollution, air pollution, light pollution, climate change, and chemical contamination {fuller2007daytime, potvin2013song, kight2011how, halfwerk2011low}. Several pollutants and components of air quality have been shown to impact the length of birdsong. Let us take a brief look at some of the environmental factors that have been found to impact bird song..
