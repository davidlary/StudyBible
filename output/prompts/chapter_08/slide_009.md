...
- } Ozone is a strong oxidizing agent and is known to damage respiratory systems in birds. For example, [patricelli2017effects] found that high levels of ozone exposure caused a significant decrease in song duration and an increase in song frequency in dark-eyed juncos (Junco hyemalis). Ozone pollution can affect birdsong by causing damage to their respiratory system, reducing lung capacity, and altering their behavior {williams2008effects, taylor2010ozone, moller2011ozone}. Ozone pollution may also impact the auditory system of birds, making it harder for them to hear and communicate effectively.
- Nitrogen dioxide (NO₂) is a gas produced by the combustion of fossil fuels and is a primary component of urban air pollution. For example, a study by [francis2013framework] showed that {-0.3in [width=1.05in]/Chapter-Birds-Plants-Animals/EuropeanRobin.jpeg} (Erithacus rubecula) European Robin } high levels of NO₂ exposure affected the singing behavior of European Robins (Erithacus rubecula) and led to a decrease in song complexity. NO₂ pollution can affect birdsong by causing oxidative stress, altering their behavior, and affecting their vocal anatomy {kempenaers2010artificial, lazerte2019anthropogenic, tieleman2003exposure}.
