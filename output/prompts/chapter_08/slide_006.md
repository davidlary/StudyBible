...
- Habitat loss is a significant environmental impact that affects bird song. The destruction of natural habitats, such as forests and wetlands, reduces the availability of suitable breeding and foraging grounds for birds, which in turn affects their vocalizations. For example, a study by [marler2004nature] found that habitat fragmentation caused by logging activities in the Amazon basin led to a decrease in bird species and altered the frequency and timing of bird vocalizations.
- If you were alive in 1970, more than one out of every four birds in the United States and Canada would have died within your lifetime by 2017. According to [Rosenberg:2019], wild bird populations in the continental United States and Canada have declined by more than 30\% since 1970. An analysis of population trends for 529 bird species reveals a catastrophic net loss across all bird species, 2.9 Billion birds have gone.
- Figure: NEXRAD radar monitoring of nocturnal bird migration across the contiguous United States:2019
