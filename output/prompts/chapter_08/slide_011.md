...
- } Carbon monoxide is a toxic gas produced by incomplete combustion of fossil fuels. [winder2021carbon] found that exposure to high levels of CO caused a decrease in song duration and an increase in song frequency in Carolina chickadees (Poecile carolinensis). Exposure to high levels of CO can cause respiratory distress, which can impact a bird's ability to sing {nemeth2009high, gerson2011impact, soler2013effects}.
- } Volatile organic compounds (VOCs) are a diverse group of organic chemicals that can be emitted from natural and anthropogenic sources. [laiolo2011song] found that VOCs emitted by trees affected the singing behavior of great tits (Parus major) and led to changes in song frequency and structure. Exposure to high levels of VOCs can cause respiratory distress {slabbekoorn2010songs, stroh2013noise, koc2017volatile}.
