...
- Light plays a role in regulating the production of hormones which can influence the quality and quantity of bird song. } Light levels can affect bird song in several ways. Changes in light levels can impact the timing and duration of singing, as well as the frequency and amplitude of vocalizations {buchanan1997song, brenowitz2005song, bailey2017review, greives2019ambient}. Light also plays a role in regulating the production of hormones such as melatonin, cortisol, and testosterone, which in turn can influence the quality and quantity of bird song.
- Figure: %Nocturnal melatonin secretion impacts the cognitive performance of diurnal animals. For example, an experiment measured the cognitive performance in Indian house crows treated for 11 days with 12 hours of light at 1.426 W/m2 (∼150 lux) coupled with 12 hours of 0.058 W/m2 (∼6-lux) dim light at night (dLAN) or with absolute darkness (0 lux dark night, LD). dLAN treatment significantly decreased midnight melatonin levels and negatively impacted cognitive performance. Subsequently, the role of exogenous melatonin (50 μg; administered intraperitoneally half an hour before the night began) was assessed on the regulation of cognitive performance in two separate experimental cohorts of crows kept under dLAN. Exogenous melatonin restored its mid-night levels under dLAN at par with those under LD controls, and improved the cognitive performance, as measured in the innovative problem-solving, and spatial and pattern learning-memory efficiency tests in dLAN-treated crows. There were concurrent molecular changes in the cognition-associated brain areas, namely the hippocampus, nidopallium caudolaterale and midbrain. In particular, the expression levels of genes involved in neurogenesis and synaptic plasticity (bdnf, dcx, egr1, creb), and dopamine synthesis and signalling (th, drd1, drd2, darpp32, taar1) were restored to LD control levels in crows treated with illuminated nights and received melatonin. These results demonstrate that the maintenance of nocturnal melatonin levels is crucial for an optimal higher-order brain function in diurnal animals in the face of an environmental threat, such as light pollution. Nocturnal melatonin secretion affects diurnal animals' cognition. For 11 days, Indian house crows were treated with 12 hours of light at 1.426 W/m2 (150 lux) and 12 hours of dim light at night (dLAN) or utter darkness (0 lux dark night, LD). dLAN treatment dramatically decreased midnight melatonin and cognitive performance. Next, two experimental cohorts of crows housed under dLAN were tested for cognitive performance control by exogenous melatonin (50 μg intraperitoneally 30 minutes before nightfall). Exogenous melatonin restored mid-night levels under dLAN to LD controls and improved cognitive function in dLAN-treated crows' inventive problem-solving, spatial, and pattern learning-memory efficiency assessments. The hippocampus, nidopallium caudolaterale, and midbrain showed molecular alterations. In particular, crows treated with illuminated nights and melatonin had LD control levels of genes associated in neurogenesis and synaptic plasticity (bdnf, dcx, egr1, creb) and dopamine production and signaling (th, drd1, drd2, darpp32, taar1). These results demonstrate that the maintenance of nocturnal melatonin levels is crucial for an optimal higher-order brain function in diurnal animals in the face of an environmental threat, such as light pollution. This schematic is taken from:2022
- Melatonin is a hormone that is primarily secreted by the pineal gland in response to changes in light levels. {-0.45in [width=1.25in]/Chapter-Birds-Plants-Animals/Melatonin.png} Melatonin } In birds, the secretion of melatonin is controlled by the suprachiasmatic nucleus (SCN) of the hypothalamus, which receives information about the light-dark cycle from the eyes. In birds, melatonin secretion is high during the night and low during the day. Changes in light levels can disrupt the normal secretion pattern of melatonin. For example, exposure to constant light can inhibit melatonin secretion, while exposure to constant darkness can increase melatonin secretion {chabot1992effects}.
- } Cortisol is a hormone that is secreted by the adrenal gland in response to stress. In birds, changes in light levels can affect cortisol secretion. For example, exposure to bright light can increase cortisol secretion in chickens {cohen1991photoperiodic}.
- } Testosterone is a hormone that is primarily secreted by the testes in male birds and plays a key role in the regulation of reproductive behavior. Changes in light levels can affect the secretion of testosterone in birds. For example, in some bird species, exposure to long days (more than 12 hours of light per day) can stimulate testosterone secretion and promote breeding behavior {wingfield1990environmental}.
- Figure: Net population change in North American birds:2019
