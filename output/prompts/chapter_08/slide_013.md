...
- Title: "The Impact of Air Quality on Plants"
...
- } Poor air quality can have significant negative impacts on plant growth, development, and reproduction, with potential consequences for food security and ecosystem health {feng2019impacts, pandey2019impacts, paul2019air, singh2019heavy, tiwari2019air}. Improving air quality by reducing emissions of pollutants can help to protect plant health and ensure the sustainability of agriculture and ecosystems. Some of the impacts of air pollution on plants include:
- High levels of air pollution, particularly nitrogen oxides, sulfur dioxide, and ozone, can cause stunted growth in plants {zhang2019ozone}. Photosynthesis is essential for plant growth. The stunted growth of plants due to poor air quality can result from a combination of physical and physiological mechanisms {paul2019air, seregin2019physiological}. High levels of air pollution can affect plant growth by interfering with the process of photosynthesis and damaging plant tissues.
- Physically, pollutants such as sulfur dioxide and ozone can cause stomatal closure, reducing the ability of plants to take up carbon dioxide for photosynthesis. This can lead to a reduction in the production of carbohydrates, which are essential for plant growth. The deposition of pollutants on plant surfaces can also reduce the amount of light that reaches the leaves, further reducing photosynthesis and plant growth {shao2019nitrogen}.
