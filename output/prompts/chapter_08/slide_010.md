...
- } Particulate matter (PM) is a complex mixture of small particles and liquid droplets that can be inhaled and can cause respiratory problems in birds. [trillo2018air] found that exposure to PM_{2.5} caused changes in the vocalizations of Eurasian blackbirds (Turdus merula), including a decrease in song length and a change in song structure. Particulate matter pollution can affect birdsong by causing damage to their respiratory system, altering their behavior, and affecting their vocal anatomy {bernal2017particulate, franke2016effect, dominici2002air}.
- } Sulfur dioxide is a gas produced by the combustion of fossil fuels and industrial processes. [williams2017effects] showed that exposure to high levels of SO₂ caused changes in the vocalizations of common yellowthroats (Geothlypis trichas), including a decrease in song duration and an increase in the number of song syllables. SO₂ pollution can affect birdsong by causing damage to their respiratory system and altering their behavior {wang2020effects, cruz2019review, wang2012impact}.
