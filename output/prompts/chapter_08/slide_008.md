...
- } Chemical contamination is another environmental impact that can affect bird song. Chemical pollutants, such as pesticides and heavy metals, can have neurotoxic effects on birds, affecting their cognitive function and vocalizations. A study by [welsh2013pesticide] found that exposure to the pesticide chlorpyrifos caused a decrease in the frequency of bird vocalizations in European starlings (Sturnus vulgaris).
- Air quality can have a significant impact on bird song through direct and indirect effects. Poor air quality can lead to respiratory problems in birds, which can affect their ability to sing. Additionally, pollutants such as ozone and nitrogen dioxide can have direct effects on bird vocalizations, altering their pitch and duration.
- Furthermore, air quality can indirectly affect bird song by altering their habitat. Poor air quality can lead to the degradation of natural habitats, making them unsuitable for bird breeding and foraging. This can lead to changes in the bird community composition and vocalizations in the affected areas. For example, a study by [savard2000biodiversity] found that the decline in bird species richness in urban areas was attributed in part to air pollution.
