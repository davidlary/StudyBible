...
- Title: "Temperature, Humidity and Pressure (Altitude)"
...
- Temperature can affect bird song by influencing the metabolic rate of the bird, the levels of various hormones, and the physical properties of the sound environment. } Temperature can affect bird song in several ways, such as by influencing the metabolic rate of the bird and the physical properties of the sound environment {morton1975ecological, termaat2014zebra, ritschard2016acoustic, slabbekoorn2006cities, nemeth2009blackbirds, halfwerk2011negative, cardoso2012modulation}. Ambient temperature can affect the production of several hormones in birds, including thyroid hormones, corticosterone, and testosterone {wingfield1998ecological, gwinner1996circannual, dawson2008control}. In turn, changes in hormone levels can impact a variety of physiological processes, including metabolism, growth, and reproduction, which in turn can influence bird behavior and vocalizations.
- Humidity can affect bird song by changing the physical properties of the sound environment, which can impact sound transmission and reception {wimmer2006effect, witter1994plumage, ritschard2016acoustic, mcnett2019high, luther2009influence, mundry2005discriminant}. Higher pressure (corresponding to a denser atmosphere), affects the absorption and scattering of sound waves, reducing their range and clarity {hedwig2004complex, witter1994plumage, ritschard2016acoustic, beckers2018song}. At higher altitudes, air density decreases, which can result in less sound absorption and increased sound transmission distance. Additionally, changes in temperature and humidity can affect the physical properties of the bird's vocal apparatus, potentially altering the frequency and amplitude of bird songs.
- Figure: The coordination of circadian and circannual patterns of behavior and physiology is the composite of multiple circadian oscillators and their interactions. At the core are circadian pacemakers in the pineal gland and suprachiasmatic nuclei (SCN), whose interactions maintain each other’s stability and self-sustainment through mutually inhibitory activity. Each of these pacemakers may influence downstream processes through entrainment of circadian oscillators controlling and residing in brain (e.g., song, vision, and migration) and peripheral (e.g., liver, heart, and muscle) function. In birds, regulation of primary gonadal activity has been separated from this circadian system with circadian oscillators residing in the mediobasal hypothalamus itself. There is little evidence that these oscillators are affected by pineal melatonin, but it is an open question whether SCM oscillators influence MBH function in the circadian and seasonal control of reproduction. This schematic is taken from {https://veteriankey.com/avian-circadian-organization/
